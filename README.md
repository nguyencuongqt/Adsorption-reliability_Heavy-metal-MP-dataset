...
of this repository. The exploratory external transportability check reported
in the Supplementary Information is also excluded: its inputs were digitized
from two independently published 2026 studies and are not redistributed here.
The public repository is limited to the locked 1,009-observation corpus and
the analyses that can be reproduced from the included data and dependencies.
